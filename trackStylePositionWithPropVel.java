...
/**
 * this tracking style combines proportional velocity style with positional style for moves > posMoveThresholdArcmin;
 * see trackStylePropVel for more comments;
 */
public class trackStylePositionWithPropVel extends trackStyleBase implements TrackStyle {
    trackStylePosition trackStylePosition = new trackStylePosition();
    trackStylePropVel trackStylePropVel = new trackStylePropVel();
