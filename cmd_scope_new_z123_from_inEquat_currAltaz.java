...
public class cmd_scope_new_z123_from_inEquat_currAltaz extends cmdScopeBase implements cmdScope {
    ...
    public boolean process(cmdScopeList cl) {
        ...
        super.process(cl);
        position p = new position("cmd_scope_new_z123_from_inEquat_currAltaz");
        ...
        rtn = cl.t.c.computeBestZ123FromPosition(p);
