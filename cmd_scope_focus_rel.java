...
public class cmd_scope_focus_rel extends cmdScopeFocusBase implements cmdScope {
    ...
    public boolean process(cmdScopeList cl) {
        ...
        cfg.getInstance().spf.targetPosition = focusPosition + cfg.getInstance().spf.actualPosition;
        ...
        if (moveTimeSec > 0.) {
            deltaFocusRad = focusPosition * cfg.getInstance().spf.countToRad;
